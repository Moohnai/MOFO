...
class GroupMultiScaleCrop_BB_no_global_union(object):
    ...
    def __call__(self, img_tuple):
        img_group, bboxs = img_tuple
        
        im_size = img_group[0].size

        crop_w, crop_h, offset_w, offset_h = self._sample_crop_size(im_size)
        transform = A.Compose([A.Crop(offset_w, offset_h, offset_w + crop_w, offset_h + crop_h), 
                                A.Resize(self.input_size[0], self.input_size[1], interpolation=1)], 
...
class GroupMultiScaleCrop_BB(object):
